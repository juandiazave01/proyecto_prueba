...
const navDropdownTrigger = document.querySelector('.nav-dropdown > a');
...
// ============================================
// RELIABILITY LIBRARY — two dropdowns, shared panel display
// ============================================
const relSelect1 = document.getElementById('rel-select-1');
const relSelect2 = document.getElementById('rel-select-2');
...
if (relSelect1 && relSelect2) {
  relSelect1.addEventListener('change', () => {
    if (!relSelect1.value) return;
    relSelect2.selectedIndex = 0; // reset the other dropdown to its placeholder
    showTopic(relSelect1.value);
  });
  relSelect2.addEventListener('change', () => {
    if (!relSelect2.value) return;
    relSelect1.selectedIndex = 0;
    relSelect1.value = '';
    showTopic(relSelect2.value);
  });
}
